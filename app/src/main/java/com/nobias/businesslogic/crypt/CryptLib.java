...
import static com.nobias.businesslogic.crypt.CryptUniqueIdGenerator.getCryptUniqueId;
...
public class CryptLib {
    ...
    public String EncryptString(String _plainText)
        ...
        String k = ConstantCodes.CRYPT_KEY;
        String i = ConstantCodes.CRYPT_IV;
        k = getCryptUniqueId() + k;
        k = SHA256(k, k.length()); //32 bytes = 256 bit
        i = SHA256(i, 16);
    ...
    public String DecryptString(String _plainText)
            ...
            BadPaddingException, NoSuchAlgorithmException {
        String k = ConstantCodes.CRYPT_KEY;
        String ivset = ConstantCodes.CRYPT_IV;
        k = getCryptUniqueId() + k;
        k = SHA256(k, k.length()); //32 bytes = 256 bit
        ivset = SHA256(ivset, 16);
        return decrypt(_plainText, k, ivset);
    }
